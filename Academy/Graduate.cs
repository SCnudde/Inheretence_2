...
namespace Academy
{
    internal class Graduate : Student
    {
        ...
        public Graduate
            ...
            string speciality, string group, double rating, 
            double attendance, string subject)
        ...
        ~Graduate()
        { 
            Console.WriteLine($"GDeconstructor: {GetHashCode()}"); 
        }
        ...
        {
            return base.ToString() + $"{Subject.PadRight(10)}";
        }
